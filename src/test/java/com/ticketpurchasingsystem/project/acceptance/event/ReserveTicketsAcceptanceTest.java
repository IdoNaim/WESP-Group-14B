...
class ReserveTicketsAcceptanceTest {
    ...
    void setUp() {
        ...
        EventDTO newEvent = new EventDTO(42, "Rock Concert", 100, LocalDateTime.now().plusDays(5), true);
        ...
        // Extract the exact dynamic keys generated by your core model from the map's real storage
