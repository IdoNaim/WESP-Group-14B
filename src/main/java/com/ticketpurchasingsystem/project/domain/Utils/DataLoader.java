...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        activeOrderService.createPendingOrder(sessionToken, "idonaim56@gmail.com", "1");
        activeOrderService.addSeatsToActiveOrder(sessionToken, "1", List.of("0_1_1"));
        activeOrderService.addStandingAreaToActiveOrder(sessionToken, "1", "1", 2);
